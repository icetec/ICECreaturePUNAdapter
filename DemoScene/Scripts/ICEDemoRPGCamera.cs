...
public class ICEDemoRPGCamera : MonoBehaviour 
{
	...
	/// <summary>
	/// Assigns the camera target. Add a method like this to your own RPG Cam script to 
	/// assign your player after spawning to its camera
	/// </summary>
